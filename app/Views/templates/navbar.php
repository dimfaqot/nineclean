    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-3">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url(); ?>">
                <img src="https://bkw.walisongosragen.com/files/<?= (session('db') == "" ? "bkw" : session("db")) ?>.png" alt="Logo" width="35">
            </a>
            <div class="d-block d-md-none d-sm-block"><?= upper_first(session('db')) ?></div>
